...
MLLAB_GPU_BACKEND=$MLLAB_GPU_BACKEND
MLLAB_NVIDIA_DRIVER_CAPABILITIES=$MLLAB_NVIDIA_DRIVER_CAPABILITIES
...
MLLAB_RUN_AS_HOST_USER=$MLLAB_RUN_AS_HOST_USER
MLLAB_CONTAINER_HOME=$MLLAB_CONTAINER_HOME
